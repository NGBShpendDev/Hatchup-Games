...
export type BadgeCategory = "fitness" | "streak" | "hatchling" | "social" | "achievement" | "event" | "secret";
...
export async function checkAndAwardBadges(playerId: number, triggers: {
  ...
  const { totalSteps, todaySteps, currentStreak, totalWorkouts, level, totalWins,
    hatchlingCount, hasEvolved, hasMythicHatchling, hasPrestige,
    activityHour, hasNamedDragon, dailyRewardStreak } = triggers;
